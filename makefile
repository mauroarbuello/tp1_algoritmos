# Fichero: makefile
# Fichero makefile para la construccion del ejecutable "nmeatogpx.exe". 
...
nmeatogpx.exe: main_def.o proc_argv_def.o procesar_fix_largo.o print_help_def.o print_salida_def.o search_coma_def.o checksum_def.o chk_gga_def.o errores_def.o get_currentdate_def.o
	...
	gcc -Wall -Wpedantic -std=c99 -o nmeatogpx.exe main_def.o proc_argv_def.o procesar_fix_largo.o print_help_def.o print_salida_def.o search_coma_def.o checksum_def.o chk_gga_def.o errores_def.o get_currentdate_def.o
